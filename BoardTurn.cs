...
public class BoardTurn : MonoBehaviour
{
    ...
    public static BoardTurn Instance { get; set; }

    private void Start()
    {
        BoardTurn.Instance = this;
    ...
    private GameObject GetTurnObject(int t)
    {
        ...
        if (gameObject == null && BoardManager.Instance.isWhiteTurn)
        {
            gameObject = UnityEngine.Object.Instantiate<GameObject>(this.PrefabsWhite[index]);
            this.turns.Add(gameObject);
        }
        else if (gameObject == null && !BoardManager.Instance.isWhiteTurn)
        {
    ...
    public void turnAllMoves(bool[,] moves, cub c, cub[,] Cubs)
    {
        int num = c.Turns;
        float rY = c.rY;
        float rZ = c.rZ;
